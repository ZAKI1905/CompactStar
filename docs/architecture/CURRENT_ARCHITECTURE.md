...
> PRESENT / PRETRAJECTORY PASS / NUMERICAL VALIDATION FAILED / NO CANDIDATE.** The
...
> baseline. No physical BNV rate/model was selected. See the
...
| Phase-6A-1 controlled BNV implementation | **PRETRAJECTORY PASS / BA12 FAIL / NO CANDIDATE** | The owner-accepted bounded implementation reached the exact P0/P1/P2 runs and matched controls, but the P2 ODE-refinement norm was `1.7255917120989046 > 1`. No candidate artifact, owner ratification, canonical integration or baseline follows. `docs/validation/PHASE6A1_CONTROLLED_BNV_NUMERICAL_FAILURE.md` |
