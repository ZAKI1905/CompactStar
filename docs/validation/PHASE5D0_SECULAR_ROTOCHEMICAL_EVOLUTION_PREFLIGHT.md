...
## 37. Canonical integration addendum — 2026-09-10

The statement at the end of section 36 is retained as historical ratification-time status. Phase-5C
was subsequently canonically integrated at
`f0106c2bbaff4e7c10750c3bd6f618f447c1720e`, with its fresh-producer governed regression and narrow
compiler-provenance policy intact. This accepted Phase-5D preflight history is now reconciled into
canonical history through the governed integration recorded in
`docs/validation/PHASE5D0_SECULAR_ROTOCHEMICAL_EVOLUTION_INTEGRATION.md`.

The preflight is **COMPLETE / INDEPENDENTLY REVIEWED / HUMAN-RATIFIED / CANONICALLY PRESENT**.
The accepted scientific contract and retained review caveats are unchanged. Production eta
evolution, Urca rates, heating/cooling coupling, realistic A18, and BNV have **NOT BEGUN**. Global
