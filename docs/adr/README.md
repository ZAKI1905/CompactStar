...
`docs/validation/PHASE4_CLOSEOUT.md:183`, `docs/validation/PHASE4_CLOSEOUT.md:219`. Those statements
retain their Phase-4-closeout meaning. **Current Phase 5A status:** ADR-0010 is ACCEPTED;
implementation has not begun (`docs/adr/ADR-0010-rotochemical-off-equilibrium-thermodynamic-contract.md:371-378`).
...
| ~~Rotochemical off-equilibrium local-state, derivative, charge-projection, lepton, data-source and temperature-scope contract~~ — **ADR-0010 ACCEPTED 2026-09-04** | Local-provider implementation/validation is next; global coefficient/evolution work remains later |
