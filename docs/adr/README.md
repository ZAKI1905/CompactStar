...
| Ordinary-star TOV surface event / termination contract — **ADR-0009 ACCEPTED, SOURCE CONFORMED, NUMERICALLY VALIDATED** | separate seven-artifact migration before corrected Phase-4D; `docs/validation/TOV_SURFACE_IMPLEMENTATION.md:590` |
