...
| [ADR-0010](ADR-0010-rotochemical-off-equilibrium-thermodynamic-contract.md) | Rotochemical off-equilibrium thermodynamic contract | **PROPOSED** | 2026-09-04 — source-backed Phase 5A-1 proposal for a common Track-R/Track-P charge-neutral local state and derivative contract; Decision **PENDING OWNER ADJUDICATION**; no thermodynamic EOS implementation |
...
| Rotochemical off-equilibrium local-state, derivative, charge-projection, lepton, data-source and temperature-scope contract — **ADR-0010 PROPOSED** | Phase 5; owner adjudication required before implementation |
