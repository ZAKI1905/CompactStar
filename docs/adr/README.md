...
| [ADR-0009](ADR-0009-tov-surface-event-and-termination.md) | Ordinary-star TOV surface event and integration-termination contract | **ACCEPTED** | 2026-09-03 — exact Q1–Q14 decisions at ADR-0009:55. Accepted-solution crossing, unchanged cutoff, trial-only EOS continuation, pressure-coordinate terminal locator, sampling-only partition and fail-closed publication. **TOV-SURF-I STOPPED at V7; source restored, conformance not achieved.** The 2.0-M☉ target-mass comparison exceeds its mass-impact bound. Artifact migration, corrected Phase-4D and the first monopole baseline remain blocked. Evidence: `docs/validation/TOV_SURFACE_IMPLEMENTATION.md:88`, `:227`. |
...
| Ordinary-star TOV surface event / termination contract — **ADR-0009 ACCEPTED 2026-09-03**, implementation stopped at V7 (`docs/validation/TOV_SURFACE_IMPLEMENTATION.md:181`) | owner review of the V7 discrepancy; source conformance and validation |
