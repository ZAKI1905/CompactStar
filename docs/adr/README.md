...
| ~~ADR-0008 Validation D monotonicity clause vs the measured O(h) node-placement floor~~ — **clarified by owner adjudication, Phase 4D-DA 2026-09-04** (`docs/validation/PHASE4D_CORRECTED_MONOPOLE_REVALIDATION.md` §21; EOS-knot partition stays optional) | first monopole baseline (separate task); Phase 4E |
