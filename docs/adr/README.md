...
| Hartle O(Ω²) monopole — **measure-complete EOS source** (internal density steps, jump operator, shell unification, Phase-5 measure completeness) — **ADR-0008 PROPOSED 2026-09-03** | owner adjudication |
