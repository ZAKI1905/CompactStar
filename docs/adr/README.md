...
| Ordinary-star TOV surface event / termination contract — **ADR-0009 ACCEPTED, SOURCE CONFORMED, NUMERICALLY VALIDATED, ARTIFACT MIGRATION COMPLETE** | corrected Phase-4D independent revalidation ready; first monopole baseline still gated on its success; `docs/validation/TOV_SURFACE_ARTIFACT_MIGRATION.md:1003` |
