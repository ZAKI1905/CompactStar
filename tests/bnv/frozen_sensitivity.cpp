...
int main(int argc,char** argv)
{
 try
 {
    ...
    const auto domain=CompactStar::Analysis::EquilibriumBaryonTangent::SerializeDomainIdentity(whole);
    for(std::size_t i=0;i<stars.size();++i)
    {
        ...
        auto tangent=CompactStar::Analysis::EquilibriumBaryonTangent::Compute(sequence,stars[i].B,
