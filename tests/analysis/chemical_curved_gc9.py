...
def run():
    ...
    for shape in (False,True):
        ...
        separations = {name:(radial_integral(64,p,v,shape)-expected)/expected
                       for name,(p,v) in mutants.items()}
