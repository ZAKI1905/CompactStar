...
#include <CompactStar/Microphysics/BNV/Analysis/BNV_Sequence.hpp>

using namespace CompactStar;
namespace MicroBNVAna = Microphysics::BNV::Analysis;

// ------------------------------------------------------------
// Default Constructor
MicroBNVAna::BNV_Sequence::BNV_Sequence()
{
...
MicroBNVAna::BNV_Sequence::BNV_Sequence(const Zaki::String::Directory &in_dir,
...
// ------------------------------------------------------------
// // Copy constructor
// MicroBNVAna::BNV_Sequence::BNV_Sequence(const BNV_Sequence& other)
// {
...
// // ------------------------------------------------------------
// // Assignment operator
// BNV_Sequence& MicroBNVAna::BNV_Sequence::operator=(const BNV_Sequence& other)
// {
...
void MicroBNVAna::BNV_Sequence::SetInitOmega()
{
...
// ------------------------------------------------------------
void MicroBNVAna::BNV_Sequence::SetInitOmegaSet(const std::vector<std::pair<double, std::string>> &init_omegas)
{
 ...
 */
void MicroBNVAna::BNV_Sequence::GenSequence(const Zaki::String::Directory &in_dir,
...
void MicroBNVAna::BNV_Sequence::Import(const Zaki::String::Directory &in_dir,
									   const std::string &in_f_name)
{
	SetWrkDir(in_dir);
	seq.SetWrkDir(in_dir);
...
void MicroBNVAna::BNV_Sequence::Find_b_O(const double &in_mass, const int &o_idx)
{
	...
	double o_3rd_der = seq[o_idx][m_idx + 3] - 3 * seq[o_idx][m_idx + 1] + 3 * seq[o_idx][m_idx - 1] - seq[o_idx][m_idx - 3];
	o_3rd_der /= h * h * h;
	...
	// Evaluate the 3rd derivative at m_idx
	double B_3rd_der = seq[4][m_idx + 3] - 3 * seq[4][m_idx + 1] + 3 * seq[4][m_idx - 1] - seq[4][m_idx - 3];
	B_3rd_der /= h * h * h;
	...
	double b_O_error = b_O * sqrt(pow(o_der_error / o_der, 2) + pow(B_der_error / B_der, 2));
	std::cout << "\n    * ================================= * ";
	std::cout << "\n\t b_O = " << b_O << " +-  " << b_O_error;
	std::cout << "\n    * ================================= * ";
}
...
// ------------------------------------------------------------
// Evaluates b_O factor using the central difference method
void MicroBNVAna::BNV_Sequence::Find_b_factors()
{
	// Find the closest index
	// int m_idx = seq[1].GetClosestIdx(in_mass) ;
	...
	for (size_t i = 2; i < seq[0].Size() - 2; i++)
	{
		...
		double b_beta_I = I_2nd_der / (I_der * B_der) - B_2nd_der / pow(B_der, 2);
		b_beta_I *= seq[4][i];
...
// Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::O(const int& idx) const
// {
//   return seq[idx] ;
// }
...
Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::Eps_C() const
{
...
// ------------------------------------------------------------
// Returns Mass
Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::M() const
{
...
double MicroBNVAna::BNV_Sequence::O(const double &time, const int &o_idx) const
{
	// double B_val = B(time) ;
	...
	double o = w_idx.w_L * beta[o_idx][w_idx.idx - 1] + w_idx.w_R * beta[o_idx][w_idx.idx];
...
double MicroBNVAna::BNV_Sequence::M(const double &time) const
{
	...
	return w_idx.w_L * M()[w_idx.idx - 1] + w_idx.w_R * M()[w_idx.idx];
...
// ------------------------------------------------------------
// Returns Mass
Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::R() const
{
...
double MicroBNVAna::BNV_Sequence::R(const double &time) const
{
	...
	return w_idx.w_L * R()[w_idx.idx - 1] + w_idx.w_R * R()[w_idx.idx];
}

// ------------------------------------------------------------
// Returns Mass
Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::I() const
{
...
double MicroBNVAna::BNV_Sequence::I(const double &time) const
{
	...
	return w_idx.w_L * I()[w_idx.idx - 1] + w_idx.w_R * I()[w_idx.idx];
}

// ------------------------------------------------------------
// Returns baryon number
Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::B() const
{
...
double MicroBNVAna::BNV_Sequence::B(const double &time) const
{
...
void MicroBNVAna::BNV_Sequence::SetBNVCuttoff(const double &time)
{
...
// ------------------------------------------------------------
void MicroBNVAna::BNV_Sequence::Plot_Dimless_O() const
{
	Zaki::Vector::DataSet Scaled_O({
		seq[0],		   // 0-eps
		seq[1] / 1.4,  // 1-(M/1.4)
		seq[2] / 12,   // 2-(R/12km)
		seq[4] / 1e57, // 3-(B/2e57)
...
void MicroBNVAna::BNV_Sequence::EvalBeta()
{
...
// ------------------------------------------------------------
// Input in yr^-1
void MicroBNVAna::BNV_Sequence::SetBNVRate(const double &in_gamma)
{
...
void MicroBNVAna::BNV_Sequence::SetBNVCuttOffMass(const double &in_M)
{
...
// ------------------------------------------------------------
// Returns Beta_I
// Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::Beta_I() const
// {
...
// ------------------------------------------------------------
// Returns Beta_R
// Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::Beta_R() const
// {
...
// ------------------------------------------------------------
// Returns Beta_M
// Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::Beta_M() const
// {
...
// ------------------------------------------------------------
// Returns b_I
Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::b_I() const
{
...
double MicroBNVAna::BNV_Sequence::b_I(const double &time) const
{
	// int idx = B().GetClosestIdx( B(time) ) ;
	...
	return w_idx.w_L * b_I()[w_idx.idx - 1] + w_idx.w_R * b_I()[w_idx.idx];
...
// ------------------------------------------------------------
// Returns b(beta_I)
Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::b_beta_I() const
{
	// return beta[beta_idx.beta_I] * beta[beta_idx.B] / beta[beta_idx.I] ;
...
double MicroBNVAna::BNV_Sequence::b_beta_I(const double &time) const
{
	// int idx = B().GetClosestIdx( B(time) ) ;
	...
	return w_idx.w_L * b_beta_I()[w_idx.idx - 1] + w_idx.w_R * b_beta_I()[w_idx.idx];
...
// ------------------------------------------------------------
// Returns b_R
Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::b_R() const
{
...
double MicroBNVAna::BNV_Sequence::b_R(const double &time) const
{
	// int idx = B().GetClosestIdx( B(time) ) ;
	...
	return w_idx.w_L * b_R()[w_idx.idx - 1] + w_idx.w_R * b_R()[w_idx.idx];
...
// ------------------------------------------------------------
// Returns b_M
Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::b_M() const
{
...
// ------------------------------------------------------------
// Returns Beta(O)
Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::Beta(const Zaki::Vector::DataColumn &in_dc) const
{
...
// ------------------------------------------------------------
// Returns b(O)
Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::b(const Zaki::Vector::DataColumn &in_dc) const
{
	Zaki::Vector::DataSet tmp_ds({beta[0], in_dc});
	tmp_ds.Interpolate(0, 1);
...
double MicroBNVAna::BNV_Sequence::b(const Zaki::Vector::DataColumn &in_dc, const double &time) const
{
	// int idx = B().GetClosestIdx( B(time) ) ;
	...
	return w_idx.w_L * b(in_dc)[w_idx.idx - 1] + w_idx.w_R * b(in_dc)[w_idx.idx];
...
int MicroBNVAna::BNV_Sequence::Time_to_Idx(const double &time) const
{
...
MicroBNVAna::BNV_Sequence::weighted_idx MicroBNVAna::BNV_Sequence::Time_to_Weighted_Idx(const double &time) const
{
	weighted_idx w_idx;
...
double MicroBNVAna::BNV_Sequence::Omega_Death_Central(const double &time)
{
...
double MicroBNVAna::BNV_Sequence::Omega_Death_Twisted(const double &time)
{
...
Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::BrIdx(const double &delta) const
{
...
double MicroBNVAna::BNV_Sequence::BrIdx(const double &t, const double &omega) const
{
	...
	double b_I_val = w_idx.w_L * b_I()[w_idx.idx - 1] + w_idx.w_R * b_I()[w_idx.idx];

	double b_R_val = w_idx.w_L * b_R()[w_idx.idx - 1] + w_idx.w_R * b_R()[w_idx.idx];

	double b_beta_I_val = w_idx.w_L * b_beta_I()[w_idx.idx - 1] + w_idx.w_R * b_beta_I()[w_idx.idx];
...
double MicroBNVAna::BNV_Sequence::BrIdx_M_Omega(double mass, double omega)
{
	...
	n += (6 * b_r * delta - b_i * pow(delta, 2) * (1 + b_beta_I()[idx])) / pow(1 - b_i * delta, 2);

	return n;
}

// ------------------------------------------------------------
int MicroBNVAna::BNV_Sequence::FindInitIdx(const double &in_mass)
{
...
double MicroBNVAna::BNV_Sequence::MagField() const
{
	return mag_field;
}
...
void MicroBNVAna::BNV_Sequence::SetMagField(const double &in_B)
{
	mag_field = in_B;
...
//        P in seconds
//        mass in solar mass
double MicroBNVAna::BNV_Sequence::ThresholdMagField(const double &bnv_rate, const double &P, const double &mass) const
{
	int idx = M().GetClosestIdx(mass);
...
double MicroBNVAna::BNV_Sequence::ODE_Coeff(const double &time) const
{
...
Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::H2R6_I() const
{
...
double MicroBNVAna::BNV_Sequence::Gamma_BNV(const double &time) const
{
	// Adding a cut-off for BNV
	if (time > bnv_cutoff_time)
		return 0;
...
double MicroBNVAna::BNV_Sequence::ExtremumOmega(const double &time) const
{
...
Zaki::Vector::DataSet MicroBNVAna::BNV_Sequence::ExtremumOmega() const
{
...
double MicroBNVAna::BNV_Sequence::Omega_2ndDer(const double &t,
...
Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::Omega_2ndDer(const double &omega)
	const
{
...
//  time and omega
double MicroBNVAna::BNV_Sequence::Omega_1stDer(const double &t, const double &omega) const
{
...
// as a function of omega
Zaki::Vector::DataColumn MicroBNVAna::BNV_Sequence::Omega_1stDer(const double &omega) const
{
...
// f[0] = Omega'(t)
// ......................
int MicroBNVAna::BNV_Sequence::ODE(double t, const double y[], double f[], void *params)
{
...
// ------------------------------------------------------------
void MicroBNVAna::BNV_Sequence::Solve(const double t_0, const double t_f)
{
	//---------------------------------------------------
	//          omega_ds Definition
	//---------------------------------------------------
	...
	for (size_t i = 0; i < init_omega_set.size(); i++)
	{
		...
		//----------------------------------------
		gsl_odeiv2_system ode_sys = {MicroBNVAna::BNV_Sequence::ODE, nullptr, 1, this};
...
void MicroBNVAna::BNV_Sequence::SetBrIdxvsTimeFileName(const std::string &f_name)
{
...
void MicroBNVAna::BNV_Sequence::SetOmegavsTimeFileName(const std::string &f_name)
{
...
void MicroBNVAna::BNV_Sequence::SetAgevsTimeFileName(const std::string &f_name)
{
...
void MicroBNVAna::BNV_Sequence::SetOmegavsMFileName(const std::string &f_name)
{
...
double MicroBNVAna::BNV_Sequence::DeathPeriod(const double &t) const
{
	double rho_6 = 1;
	double chi = 1. / 15.;
...
//  "Theory of Pulsars: Polar Gaps, Sparks, and Coherent Microwave Radiation"
//  by Ruderman & Sutherland (1974)
double MicroBNVAna::BNV_Sequence::DeathOmega(const double &t) const
{
...
//  output is in [s^-3]
double MicroBNVAna::BNV_Sequence::Freq_ddot(const double &nu,
											const double &nu_dot) const
{
	double nu_ddot = -(b_I(0) + 6 * b_R(0)) * gamma_bnv * nu_dot;
	nu_ddot += b_I(0)
			   // * (6*b_R(0) - 1 - b(Beta_I(), 0))
			   * (6 * b_R(0) - 1 - b_beta_I(), 0) * pow(gamma_bnv, 2) * nu;
...
double MicroBNVAna::BNV_Sequence::Gamma_Max() const
{
