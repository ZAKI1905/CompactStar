...
#include "CompactStar/Microphysics/BNV/Channels/BNV_B_Chi_Transition.hpp"
...
//==============================================================
// Constructor
MicroBNVCh::BNV_B_Chi_Transition::BNV_B_Chi_Transition()
...
MicroBNVCh::BNV_B_Chi_Transition::~BNV_B_Chi_Transition() {}
//--------------------------------------------------------------
MicroBNVInt::BNV_Chi::Process MicroBNVCh::BNV_B_Chi_Transition::GetSpecificProcess(const Baryon &B) const
{
...
// Zaki::Vector::DataColumn MicroBNVCh::BNV_B_Chi_Transition::SigmaPlus(
//                         const double& m_chi,
//                         const Baryon& B)
// {
...
// The arguments are (m_chi, m_B^*, n [fm^-3] ).
Zaki::Vector::DataColumn MicroBNVCh::BNV_B_Chi_Transition::SigmaMinus(
	...
	const Baryon &B)
{
	...
	Zaki::Vector::DataColumn out = m_B_ds[B.label] * m_B_ds[B.label] + in_m_chi * in_m_chi + 2 * kF_2;
...
// self-energy, from condition (a).
// The arguments are (m_chi, m_B^*, n [fm^-3] ).
double MicroBNVCh::BNV_B_Chi_Transition::SigmaMinus(
	const double &m_chi,
	const double &m_B,
	const double &n_B)
{
...
// self-energy, from condition (b).
// The arguments are (m_chi, m_B^*, n [fm^-3] ).
// double MicroBNVCh::BNV_B_Chi_Transition::SigmaPlus(
//                   const double& m_chi,
//                   const double& m_B,
//                   const double& n_B)
// {
...
Zaki::Vector::DataSet MicroBNVCh::BNV_B_Chi_Transition::Rate_vs_R(
	const double &m_chi,
	const Baryon &B,
	const bool &gen_plots)
{
	...
	if (!n_r_col || !r_col || !frac_col)
	{
		return Zaki::Vector::DataSet{};
	}

	// make local copies because we’re going to do arithmetic
	Zaki::Vector::DataColumn n_r = *n_r_col;
	Zaki::Vector::DataColumn r = *r_col;
	Zaki::Vector::DataColumn n_B_r = n_r * (*frac_col);
...
// // This function returns the B -> chi decay rate
// //  as a function of radius in units of s^-1/fm^3
// void MicroBNVCh::BNV_B_Chi_Transition::Rate_vs_R(const double& m_chi)
// {
...
Zaki::Vector::DataSet MicroBNVCh::BNV_B_Chi_Transition::Rate_vs_Density(
	const double &m_chi,
	const Baryon &B,
	const bool &gen_plots)
{
...
// //  and in units of [ s^-1 ]
// double MicroBNVCh::BNV_B_Chi_Transition::GetRateLim(const double& m_chi,
//                           const Baryon& B)
// {
...
// //  and in units of [ MeV ]
// double MicroBNVCh::BNV_B_Chi_Transition::GetEpsLim(const double& m_chi,
//                                         const Baryon& B)
// {
...
void MicroBNVCh::BNV_B_Chi_Transition::PlotTransCond(const double &m_chi,
													 const Baryon &B)
{
...
void MicroBNVCh::BNV_B_Chi_Transition::PlotTransBand(const Baryon &B)
{
...
//--------------------------------------------------------------
// Plots the transition band as a function of m_chi
void MicroBNVCh::BNV_B_Chi_Transition::PlotTransBand()
{
