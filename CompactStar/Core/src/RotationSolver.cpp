...
//   Z_LOG_INFO("TOV solution imported from: "+ (wrk_dir_+f_name).Str()+".") ;
...
int RotationSolver::ODE_Mixed(double r, const double y[], double f[], void *params)
{
	...
	// Second derivative of bar{omega(r)}
	f[1] = -4. * y[1] / r + rot_obj->GetHartleOmegaCoeff_Mixed(r) * y[0] + y[1] * rot_obj->GetHartleDOmegaCoeff_Mixed(r);
...
int RotationSolver::ODE_N_Fast(double r, const double y[], double f[], void *params)
{
	...
	// Second derivative of bar{omega(r)}
	f[1] = -4. * y[1] / r + rot_obj->GetHartleOmegaCoeff_N_Fast(r) * y[0] + y[1] * rot_obj->GetHartleDOmegaCoeff_N_Fast(r);
...
int RotationSolver::ODE_Mixed_Fast(double r, const double y[], double f[], void *params)
{
	...
	// Second derivative of bar{omega(r)}
	f[1] = -4. * y[1] / r + rot_obj->GetHartleOmegaCoeff_Mixed_Fast(r) * y[0] + y[1] * rot_obj->GetHartleDOmegaCoeff_Mixed_Fast(r);
