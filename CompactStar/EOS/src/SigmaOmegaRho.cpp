...
//==============================================================
// Constructor
CompactStar::SigmaOmegaRho::SigmaOmegaRho() 
: Model({0.01, 10*0.153 }),
...
//--------------------------------------------------------------
void CompactStar::SigmaOmegaRho::SetPars(const SigmaOmegaPar& in_pars)
{
  params = in_pars ;
...
//--------------------------------------------------------------
void CompactStar::SigmaOmegaRho::SetXRhos(const gsl_vector* x)
{
...
//--------------------------------------------------------------
int CompactStar::SigmaOmegaRho::Eq(const gsl_vector* x, gsl_vector* in_f)
{
  // g_sigma * sigma
...
int CompactStar::SigmaOmegaRho::SolveEq()
{
  ...
  Zaki::Math::GSLMultiFWrapper<SigmaOmegaRho, 
    int (SigmaOmegaRho::*)(const gsl_vector*, gsl_vector*)> 
  func(this, &SigmaOmegaRho::Eq, eq_size) ;
...
//--------------------------------------------------------------
// Prints the status
void CompactStar::SigmaOmegaRho::PrintState(const size_t& iter, 
...
//--------------------------------------------------------------
/// Jacobian
int CompactStar::SigmaOmegaRho::Jacob(const gsl_vector* x, gsl_matrix* J)
{
  const double gsig = gsl_vector_get(x,0);
...
//--------------------------------------------------------------
int CompactStar::SigmaOmegaRho::EqFdf(const gsl_vector* x, gsl_vector* in_f, gsl_matrix* J) 
{
  const double gsig = gsl_vector_get(x,0);
...
int CompactStar::SigmaOmegaRho::SolveEqJacob()
{
  ...
  Zaki::Math::GSLMultiFdfWrapper<SigmaOmegaRho, 
    int (SigmaOmegaRho::*)(const gsl_vector*, gsl_vector*), 
    int (SigmaOmegaRho::*)(const gsl_vector*, gsl_matrix*),
    int (SigmaOmegaRho::*)(const gsl_vector*, gsl_vector*, gsl_matrix*)
    > 
    fdf(this, &SigmaOmegaRho::Eq, &SigmaOmegaRho::Jacob, 
      &SigmaOmegaRho::EqFdf, eq_size) ;
...
//--------------------------------------------------------------
// Energy density
double CompactStar::SigmaOmegaRho::EDens(const double& in_rho) 
{
  SetRho(in_rho) ;
  UpdatePool(in_rho) ;
  SolveEq() ;
...
//--------------------------------------------------------------
// Pressure
double CompactStar::SigmaOmegaRho::Press(const double& in_rho) 
{
  SetRho(in_rho) ;
  UpdatePool(in_rho) ;
  SolveEq() ;
...
void CompactStar::SigmaOmegaRho::UpdatePool(const double& in_rho) 
{
  Particle::EmptyPool() ;
...
std::vector<double> CompactStar::SigmaOmegaRho::EOSRow(const double& rho_i) 
{
  return {EDens(rho_i), Press(rho_i), rho_i, 
          proton.Rho/rho_i, neutron.Rho/rho_i, 
...
std::string CompactStar::SigmaOmegaRho::EOSHeader() const
{
  char tmp_header[500] ;
...
void CompactStar::SigmaOmegaRho::FindGuess(const double& in_rho) 
{
...
void CompactStar::SigmaOmegaRho::SetEquilibriumEqs(const double& in_rho) 
{
